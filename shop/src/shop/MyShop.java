...
public class MyShop implements IShop {
	...
	public void genProduct() {
		...
		product.add(new CellPhone("갤럭시노트10", 1000000, "SKT"));
		product.add(new CellPhone("아이폰11", 1500000, "KT"));
		product.add(new CellPhone("샤오미", 500000, "LGU+"));
		product.add(new SmartTV("삼성UHD", 1500000, "4K"));
		product.add(new SmartTV("LGOLED", 3000000, "8K"));
	}
	@Override
	public void start() {
...
//		System.out.println("[1]"+users[1].getName()+"("+users[1].getPayType()+")");
	...
	public void productList() {
		...
		case "0" : case "1" : case "2" : case "3" : case "4":
				carts.add(product.get(Integer.parseInt(sel)));
